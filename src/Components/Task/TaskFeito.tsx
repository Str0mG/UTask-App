...
const Task = (task:any) => {
    ...
    const [emoti, setEmoti] = React.useState<'chevron-small-up' | 'chevron-small-down'>('chevron-small-up');
    ...
    return (
        <View style={styles.container}>
                ...
                <View style={{position:'absolute', right:0,bottom:0, flexDirection:'row',alignItems:'center', padding:8}}>
                    <AntDesign name="leftcircleo" size={21} color="black"  onPress={handlePrev} style={{paddingRight:2,paddingBottom:7}}   />
                    
                    <MaterialIcons name="replay" size={21} color="black" onPress={handleReplay} style={{paddingRight:2, paddingBottom:8}}   />
                </View>
